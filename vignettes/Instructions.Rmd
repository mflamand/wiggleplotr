...
plotCoverage(exons=exons, # list of exons
             ...
             fill_palette =  c("black","orange") , # colors for each dataset (at least as much as number of conditions)
...
Plots can also be returned as individual panels to change aesthetics for final plotting:
